        ...
        <v-row class="text-center lighten-4 blue">
          <v-col offset-lg="2" lg="8" md="12">
            <v-simple-table>
              ...
              <tbody>
                <tr
                  v-for="(tarefa, indice) in listaTarefas"
                  :key="indice"
                ...
                >
                  ...
                  <td class="text-left">
                    <v-btn
                      ...
                      v-if="!tarefa.feita"
                      @click="alteraStatusTarefa(tarefa)"
                      ><v-icon left> mdi-clipboard-text-off-outline </v-icon>
                      Feito</v-btn
                    >
                    <v-btn
...
export default {
  ...
  methods: {
    ...
    excluiTarefa() {
      this.listaTarefas.pop(this.tarefa);
    },
  },
};
</script>
